...
export const analyzeResume = async (req,res)=>{
    try{
        ...
        return res.status(500).json({message: error.message || "Error analyzing resume"});
    }
};
        ...
        const messages=[
            {
                ...
                Strict Rules:
                    ...
                    Make questions based on candidate's role, experience, interviewMode, projects, skills, and resume details.
