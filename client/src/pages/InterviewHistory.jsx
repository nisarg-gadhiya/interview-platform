...
const InterviewHistory = () => {
  ...
  return (
    <div className='min-h-screen bg-linear-to-br from-gray-50 to-emerald-50 py-10'>
        <div className='w-[90vw] lg:[70vw] max-w-[90%] mx-auto'>
            ...
            <div className='grid gap-6'>
                {
                    interviews.map((item,index)=>(
                        <div onClick={()=>navigate(`/report/${item._id}`)} key={index} className='bg-white p-6 rounded-2xl shadow-md hover:shadow-xl transition-all duration-300 cursor-pointer border border-gray-100'>
